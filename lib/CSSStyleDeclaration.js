...
CSSStyleDeclaration.prototype = Object.create(Object.prototype, {
  ...
  getPropertyValue: {
    value: function(property) {
      ...
      var parsedPropertyValue = this._parsed.property[property] || "";
...
var inheritedProperties = [cssProperties.borderCollapse,
  cssProperties.borderSpacing, cssProperties.captionSide,
  cssProperties.color, cssProperties.cursor, cssProperties.direction,
  cssProperties.elevation, cssProperties.emptyCells,
  cssProperties.fontFamily, cssProperties.fontSize, cssProperties.fontStyle,
  cssProperties.fontVariant, cssProperties.fontWeight, cssProperties.font,
  cssProperties.letterSpacing, cssProperties.lineHeight,
  cssProperties.listStyleImage, cssProperties.listStylePosition,
  cssProperties.listStyleType, cssProperties.listStyle,
  cssProperties.orphans, cssProperties.pitchRange, cssProperties.pitch,
  cssProperties.quotes, cssProperties.richness, cssProperties.speakHeader,
  cssProperties.speakNumeral, cssProperties.speakPunctuation,
  cssProperties.speak, cssProperties.speechRate, cssProperties.stress,
  cssProperties.textAlign, cssProperties.textIndent,
  cssProperties.textTransform, cssProperties.visibility,
  cssProperties.voiceFamily, cssProperties.volume, cssProperties.whiteSpace,
  cssProperties.widows, cssProperties.wordSpacing];
